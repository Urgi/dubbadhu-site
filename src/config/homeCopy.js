...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Subscribe in the Dubbadhu app via Apple In-App Purchase or Google Play Billing. Cancel anytime in your App Store or Play Store subscription settings. Restore purchases in the app if you reinstall or switch devices on the same store account.",
  },
  {
